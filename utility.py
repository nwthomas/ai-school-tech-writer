...
def call_openai(prompt):
    client = ChatOpenAI(api_key=os.getenv("OPEN_AI_API_KEY"), model="gpt-3.5-turbo")
    ...
    try:
        ...
        parser = StrOutputParser() # Pulls out the content without the metadata
...
def update_readme_and_create_pr(repo, updated_readme, readme_sha):
    ...
    pr_title = "AI PR: Update REAMDE based on recent change"
